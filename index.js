...
// Configuration
const apikey = ''; // Isi Dengan Apikey
const capikey = ''; // Isi Dengan Capikey
const domain = ''; // Isi Dengan Domain
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = ''; // Isi Dengan Token Bot Telegram
const adminTelegramId = ''; // Isi Dengan ID Telegram
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'Rizumodusu' && password === 'Rizumodusu123') {
    res.json({ success: true, user: { username: 'Rizumodusu', role: 'admin' } });
  } else {
